...
def DI1():
    ...
    XML = "<PACKET><HEAD><SYS_COMPANY>1004</SYS_COMPANY><SERVICE_CODE>T03_OT_004</SERVICE_CODE><FILE_TYPE>PLQZ</FILE_TYPE><REQUEST_TIME>2017-07-05 09:00:00</REQUEST_TIME><ACCESS_TOKEN>" + token4 + "</ACCESS_TOKEN><HANDLE_TYPE>1</HANDLE_TYPE><CUST_COMPANY>1003</CUST_COMPANY><ACCOUNT_PERIOD>201704</ACCOUNT_PERIOD><PROVINCE_ID>370000</PROVINCE_ID><CITY_ID>370100</CITY_ID><FLOW_ID></FLOW_ID><STATUS>1</STATUS></HEAD></PACKET>"
    print "请求报文明文:\n", XML
    ...
    try:
        ...
        try:
            ...
            for i in range(4):
                ...
                ftp.storbinary('STOR T06_OT_005-1003-130000-130600-201708.xlsx',up_file,bufsize)
                ftp.storbinary('STOR T06_OT_005-1003-130000-130600-201709.xlsx',up_file,bufsize)
                ftp.storbinary('STOR T06_OT_005-1003-130000-130600-201710.xlsx',up_file,bufsize)
                ftp.storbinary('STOR T06_OT_005-1003-130000-130600-201711.xlsx',up_file,bufsize)
                ftp.storbinary('STOR T06_OT_005-1003-130000-130600-201712.xlsx',up_file,bufsize)
        except:
            print "up file error"
            print ">>>>FLOW_ID:\t%s"%l4
            sys.exit()
...
def DI3():
    ...
    num = flow_id
    token4 = "MTAwNDAwMFQwM19PVF8wMDQ5OTkyMDE3LTA4"
    XML = "<PACKET><HEAD><SYS_COMPANY>1004</SYS_COMPANY><SERVICE_CODE>T03_OT_004</SERVICE_CODE><FILE_TYPE>PLQZ</FILE_TYPE><REQUEST_TIME>2017-07-05 09:00:00</REQUEST_TIME><ACCESS_TOKEN>"+ token4 +"</ACCESS_TOKEN><HANDLE_TYPE>3</HANDLE_TYPE><CUST_COMPANY>1003</CUST_COMPANY><ACCOUNT_PERIOD>201704</ACCOUNT_PERIOD><PROVINCE_ID>370000</PROVINCE_ID><CITY_ID>370100</CITY_ID><FLOW_ID>"+ num +"</FLOW_ID><STATUS>1</STATUS></HEAD></PACKET>"
    print "请求报文明文:\n", XML
    r0 = requests.post(config.encode, data={'requestXml':XML})
    en = r0.content.replace(r"\n","")[1:-1]
#    print "请求报文密文:\n", en
...
#    print "请求返回的加密报文:\n", cc
    ...
    try:
        ...
        try:
            ...
            ftp.retrbinary('RETR T06_OT_005-1003-130000-130600-201708.xlsx',down_file2,bufsize)
        except:
